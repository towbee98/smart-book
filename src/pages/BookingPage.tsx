...
export function BookingPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 animate-slide-down">
        Book Your Service
      </h1>
      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-sm p-4 sm:p-6 transition-all duration-300 hover:shadow-md animate-slide-up">
          <h2 className="text-lg sm:text-xl font-semibold mb-4">1. Select Your Vehicle</h2>
          <VehicleSelector />
        </section>
        ...
        <section className="bg-white rounded-lg shadow-sm p-4 sm:p-6 transition-all duration-300 hover:shadow-md animate-slide-up delay-100">
          <h2 className="text-lg sm:text-xl font-semibold mb-4">2. Choose Your Service</h2>
          <ServiceSelector />
        </section>
        ...
        <section className="bg-white rounded-lg shadow-sm p-4 sm:p-6 transition-all duration-300 hover:shadow-md animate-slide-up delay-200">
          <h2 className="text-lg sm:text-xl font-semibold mb-4">3. Select a Station</h2>
          <StationSelector />
        </section>
        ...
        <section className="bg-white rounded-lg shadow-sm p-4 sm:p-6 transition-all duration-300 hover:shadow-md animate-slide-up delay-300">
          <h2 className="text-lg sm:text-xl font-semibold mb-4">4. Choose a Time Slot</h2>
          <TimeSlotSelector />
        </section>
      </div>
    </div>
